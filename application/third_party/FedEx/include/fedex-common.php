<?php
	...
	{
		// if($var == 'key') Return 'Ae0IBPQ38ym7HHkf'; 
		// if($var == 'password') Return 'wS26cjsHEOUmp1OAYhZe0YwKl'; 
		// if($var == 'shipaccount') Return '510087526';
		// if($var == 'billaccount') Return '510087526'; 
		// if($var == 'dutyaccount') Return '510087526'; 
		// if($var == 'freightaccount') Return '510087526';  
		// if($var == 'trackaccount') Return '510087526'; 
		// if($var == 'dutiesaccount') Return '510087526';
		// if($var == 'importeraccount') Return '510087526';
		// if($var == 'brokeraccount') Return '510087526';
		// if($var == 'distributionaccount') Return '510087526';
		if($var == 'key') Return MCC_FEDEX_ACESS_KEY; 
		if($var == 'password') Return MCC_FEDEX_PASSWORD; 
		if($var == 'shipaccount') Return MCC_FEDEX_ACCOUNT_NUMBER;
		if($var == 'billaccount') Return MCC_FEDEX_ACCOUNT_NUMBER; 
		if($var == 'dutyaccount') Return MCC_FEDEX_ACCOUNT_NUMBER; 
		if($var == 'freightaccount') Return MCC_FEDEX_ACCOUNT_NUMBER;
		if($var == 'trackaccount') Return MCC_FEDEX_ACCOUNT_NUMBER; 
		if($var == 'dutiesaccount') Return MCC_FEDEX_ACCOUNT_NUMBER;
		if($var == 'importeraccount') Return MCC_FEDEX_ACCOUNT_NUMBER;
		if($var == 'brokeraccount') Return MCC_FEDEX_ACCOUNT_NUMBER;
		if($var == 'distributionaccount') Return MCC_FEDEX_ACCOUNT_NUMBER;
		...
		if($var == 'meter') Return MCC_FEDEX_METER_NUMBER;
		if($var == 'shiptimestamp') Return mktime(10, 0, 0, date("m"), date("d")+2, date("Y"));
		...
		if($var == 'pickupdate') Return date("Y-m-d", mktime(8, 0, 0, date("m")  , date("d")+2, date("Y")));
		if($var == 'pickuptimestamp') Return mktime(8, 0, 0, date("m")  , date("d")+2, date("Y"));
		if($var == 'pickuplocationid') Return 'XXX';
		if($var == 'pickupconfirmationnumber') Return '1';
		if($var == 'dispatchdate') Return date("Y-m-d", mktime(8, 0, 0, date("m")  , date("d")+2, date("Y")));
		if($var == 'dispatchlocationid') Return 'XXX';
		if($var == 'dispatchconfirmationnumber') Return '1';		
		if($var == 'tag_readytimestamp') Return mktime(10, 0, 0, date("m"), date("d")+2, date("Y"));
		if($var == 'tag_latesttimestamp') Return mktime(20, 0, 0, date("m"), date("d")+2, date("Y"));	
		...
		if($var == 'trackingnumber') Return '794661662576';
		...
		(
			'Contact' => array
			(
				'PersonName' => 'Rubaiet Mahbub',
				'CompanyName' => 'Entrance Logic System',
				'PhoneNumber' => '1234567890'
			),
