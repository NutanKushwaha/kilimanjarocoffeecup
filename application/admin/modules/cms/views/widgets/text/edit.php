...
<form action="cms/widgets/edit/<?php echo $widget['widget_id']; ?>" method="post" enctype="multipart/form-data" name="add_frm" id="add_frm">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="formtable">
        ...
        <tr>
            <th>Text Contents</th>
            <td><textarea name="widget_text_content" class="textfield width_99" id="widget_text_content" rows="5"><?php echo set_value('widget_text_content', $widget_data['widget_text_content']); ?></textarea></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
