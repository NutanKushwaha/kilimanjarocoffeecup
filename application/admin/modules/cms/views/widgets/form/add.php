...
<form action="cms/widgets/add_2/<?php echo $page['page_id']; ?>/<?php echo $widget_type['widget_type_id']; ?>" method="post" enctype="multipart/form-data" name="add_frm" id="add_frm">
    <div id="tabs">
        ...
        <div id="tabs-1">
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="formtable">
                <tr>
                    ...
                    <td width="85%"><?php echo form_dropdown('widget_location_id', $locations, set_value('widget_location_id'), ' class="textfield"'); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo form_dropdown('form_id', $forms, set_value('form_id'), ' class="textfield"'); ?></td>
                </tr>
        ...
        <div id="tabs-2">
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="formtable">
                <tr>
                    <td><textarea name="widget_form_template" class="textfield width_99" id="widget_form_template" rows="5"><?php echo set_value('widget_form_template'); ?></textarea></td>
                </tr>
