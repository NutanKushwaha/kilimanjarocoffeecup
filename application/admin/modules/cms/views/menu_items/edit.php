<header class="panel-heading">
    <div class="row">
       <div class="col-sm-9">
            <a href="cms/menu_item/index/<?php echo $menu_item['menu_id']; ?>">  <h3 style="margin: 0;color: #444;"> <i class="fa fa-edit" title="Manage Menu Items"></i> Edit Menu Item</h3></a>
        </div>
...
<div class="col-sm-12 padding-0" style="margin-top: 15px">
    <div id="cms">
        ...
        $attr = [];
        $attr['id'] = 'regFrm';
        echo form_open('cms/menu_item/edit/' . $menu_item['menu_item_id'], $attr);
        ?>
