...
class Auth_admin extends CI_Controller {
    ...
    function __construct() 
    {
		...
		$this->load->vars('base_url', 'http://localhost/fcode3/');
		$this->load->vars('includes_dir', 'http://localhost/fcode3/includes/');
	...
	*/
	...
	function list_user_status($status = FALSE)
	{
		...
		{
			// For this example, prevent any 'admin' users being listed to non master admins.
